...
import { CaptureCancelledError, type AdapterRegistry, type VisionResult, type VisionScene } from '../ports';
...
export async function captureRoomAndRecognize(
  ...
  try {
    ...
    try {
      ...
      // identical.
      console.warn('[myWorldPipeline] recognition-failed (vision call threw):', err);
